            ...
            <form onSubmit={handleRegister} className={style.registerForm}>
                <div style={{paddingTop: "90px", paddingLeft: "70px"}}>
                    ...
                    <div style={{display: "flex", flexDirection: "column", color: "red"}}>
                        ...
                        {errorMessage && <span>{setErrorMessage(errorMessage)}</span>}
                    </div>
                    <input type={"password"} placeholder={"Enter a valid password"} name={"password"}
                ...
                <button style={{
                    ...
                    border: "1px ",
                    marginLeft:"64px",borderRadius:"7px",color:"white", fontSize:"20px"}}>submit</button>
            </form>
        </div>
    )
}
